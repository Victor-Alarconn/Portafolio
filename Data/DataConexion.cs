...
namespace Portafolio.Data
{
    public class DataConexion
    {
        ...
        public static class ConfiguracionBD
        {
            ...
            {
                { "Local", "Server=192.168.1.150;User ID=root;Password=**Rm20So23fT**;Database=porta;SslMode=None" },
                { "Produccion", "Server=200.118.190.167;User ID=RmSoft20X;Password=*LiLo89*;Database=porta;SslMode=None" }
            };
